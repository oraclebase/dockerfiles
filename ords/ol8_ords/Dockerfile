...
ENV JAVA_SOFTWARE="OpenJDK11U-jdk_x64_linux_hotspot_11.0.15_10.tar.gz"         \
    TOMCAT_SOFTWARE="apache-tomcat-9.0.64.tar.gz"                              \
    ORDS_SOFTWARE="ords-22.2.0.172.1758.zip"                                   \
    APEX_SOFTWARE="apex_22.1_en.zip"                                           \ 
    SQLCL_SOFTWARE="sqlcl-22.2.0.172.1718.zip"                                 \
