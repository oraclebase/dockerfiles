...
#
# docker build -t ol7_t9_j9_ords18:latest .
# docker build --squash -t ol7_t9_j9_ords18:latest .
#
# docker run -dit --name ol7_t9_j9_ords18_con -p 8080:8080 -p 8443:8443 --network=my_network -e DB_HOSTNAME=ol7_122_con ol7_t9_j9_ords18:latest
#
# docker logs --follow ol7_t9_j9_ords18_con
# docker exec -it ol7_t9_j9_ords18_con bash
#
# docker stop --time=30 ol7_t9_j9_ords18_con
# docker start ol7_t9_j9_ords18_con
#
# docker rm -vf ol7_t9_j9_ords18_con
#
# ------------------------------------------------------------------------------
...
ENV JAVA_SOFTWARE="jdk-9.0.4_linux-x64_bin.tar.gz"                             \
    TOMCAT_SOFTWARE="apache-tomcat-9.0.6.tar.gz"                               \
    ORDS_SOFTWARE="ords.18.1.1.95.1251.zip"                                    \
    APEX_SOFTWARE="apex_5.1.4_en.zip"                                          \
    SQLCL_SOFTWARE="sqlcl-18.1.0.zip"                                          \
