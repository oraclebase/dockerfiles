...
# Podman
# docker build --format docker --no-cache -t ol7_19:latest .
#
...
# docker run -dit --name ol7_19_con -p 1521:1521 -p 5500:5500 --shm-size="1G" --network=my_network -v /u01/volumes/ol7_19_con_u02/:/u02 ol7_19:latest
#
